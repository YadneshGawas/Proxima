...
export default function HackathonDetail() {
  ...
  const handleMarkInterested = async () => {
    ...
    try {
      ...
      toast({
        title: isInterested ? 'Removed from interested' : 'Marked as interested',
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">{formatDate(hackathon.deadline)}</p>
                  </div>
                </div>
                <Separator />
                <div className="flex items-start gap-3">
                  ...
                  <>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-foreground">${hackathon.entryFee}</p>
                      </div>
                    </div>
                  </>
                )}
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    <p className="text-2xl font-bold text-foreground">{hackathon.registeredCount}</p>
                    <p className="text-sm text-muted-foreground">Registered</p>
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-foreground">{hackathon.interestedCount}</p>
